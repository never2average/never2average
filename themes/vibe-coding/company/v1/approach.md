...
Relay came out of a very specific frustration. Vibe coding made it easy to commoditize historical expertise. Building a normal full-stack app, especially an internal app, was already a documented process. The models made that process faster.

That is useful. But I do not think it is where the most value is.

At public-market scale, user value in many software categories has already started to stagnate. If you vibe code a Salesforce with a 20% better UI, the company does not suddenly become 20% more valuable. It is still trapped by the value ceiling of the category. Salesforce itself grows at a certain rate. A better wrapper does not break that ceiling.

The harder problem is different. It is much harder to vibe code ChatGPT than Salesforce, even though ChatGPT has fewer screens. The hard part is not screen count. It is the amount of engineering required per screen, especially at different scale checkpoints.
