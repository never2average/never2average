...
1. Built a Solana protocol funding open-source software supply chains with crypto, raising ~$50,000 in grants.
2. Among the first to run a wholesale data-engineering migration onto Azure's Jio India West region, moving infrastructure from Singapore to India.
3. Built a structured-extraction product turning company filing links into clean structured data for the world's largest derivatives exchange.
4. Shipped [OnFinance](https://onfinance.in)'s mobile app to 100,000+ installs.
5. Built South East Asia's premier agentic GRC product at [OnFinance](https://onfinance.in).
6. Implemented ETL on Cassandra at one-billion-event scale.
7. Forbes 30 Under 30 Asia, class of 2024 (Finance).

## Core Thesis
We are wasting too many tokens. As consumers, we need to get better at using tokens 

## Top wasters of tokens:
1. [Software development for the last generation of full-stack apps](top-wasters-of-tokens/last-gen-full-stack-development/)
2. [Software development lifecycle for vertical AI products](top-wasters-of-tokens/vertical-ai-product-sdlc/)
3. [Conventional code writing patterns](top-wasters-of-tokens/conventional-code-writing-patterns/)
4. [Tasks that can be repeated with one-time code generation (zero-token architecture)](top-wasters-of-tokens/zero-token-architecture/)
5. [Agentic "code-review"](top-wasters-of-tokens/agentic-code-review/)
6. ["Highly parallel" workflows](top-wasters-of-tokens/highly-parallel-workflows/)
7. [Context graphs](top-wasters-of-tokens/context-graphs/)

## Core things I enjoy working on:
1. [Moulds and the vibe-coding factory](core-things-i-enjoy-working-on/moulds-and-the-vibe-coding-factory/)
2. [Monastery pattern for Agent Harness(es)](core-things-i-enjoy-working-on/monastery-pattern-for-agent-harnesses/)
3. [Attributing the ROI of my token spend](core-things-i-enjoy-working-on/attributing-roi-of-token-spend/)
4. [Unified theory of compute](core-things-i-enjoy-working-on/unified-theory-of-compute/)
5. [Multiplayer AI](core-things-i-enjoy-working-on/multiplayer-ai/)
6. [Auto-formalization of software and business problems](core-things-i-enjoy-working-on/auto-formalization/)
...
📍 Bengaluru, India <br>
✉️ priyesh@onfinance.in · priyesh.sriv2017@gmail.com <br>
𝕏 [@fpdotmoney](https://x.com/fpdotmoney)
